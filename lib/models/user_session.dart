...
class UserSession extends HiveObject {
  ...
  UserSession copyWith({
    ...
    Object? projectStartWindow = _unset,
    UserPreferences? preferences,
    AiSettings? aiSettings,
    Object? lastSyncedAt = _unset,
    List<Map<String, dynamic>>? igPosts,
    Object? igStatsRefreshedAt = _unset,
    bool? bigProjectSubmitted,
    Object? promptConfirmedAt = _unset,
    List<String>? projectGearUsed,
    List<ProjectSummary>? projectSummaries,
    String? tier,
    Object? trialStartedAt = _unset,
    ...
    return UserSession(
      ...
      selectedPromptId: identical(selectedPromptId, _unset) ? this.selectedPromptId : selectedPromptId as String?,
      workflow: workflow ?? this.workflow,
      submittedAt: identical(submittedAt, _unset) ? this.submittedAt : submittedAt as String?,
      statsRecordedAt: identical(statsRecordedAt, _unset) ? this.statsRecordedAt : statsRecordedAt as String?,
      ...
      projectStartWindow: identical(projectStartWindow, _unset) ? this.projectStartWindow : projectStartWindow as ProjectStartWindow?,
      ...
      igStatsRefreshedAt: identical(igStatsRefreshedAt, _unset) ? this.igStatsRefreshedAt : igStatsRefreshedAt as String?,
      bigProjectSubmitted: bigProjectSubmitted ?? this.bigProjectSubmitted,
      promptConfirmedAt: identical(promptConfirmedAt, _unset) ? this.promptConfirmedAt : promptConfirmedAt as String?,
      projectGearUsed: projectGearUsed ?? this.projectGearUsed,
      projectSummaries: projectSummaries ?? this.projectSummaries,
      tier: tier ?? this.tier,
      trialStartedAt: identical(trialStartedAt, _unset) ? this.trialStartedAt : trialStartedAt as String?,
      subscriptionExpiresAt: identical(subscriptionExpiresAt, _unset) ? this.subscriptionExpiresAt : subscriptionExpiresAt as String?,
    );
  }
}
